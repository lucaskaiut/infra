...
def jobName = "deploy-nox-cms-webhook"
...
job.setDefinition(new CpsScmFlowDefinition(scm, "ci/jenkins/DeployNoxCmsWebhook.Jenkinsfile"))
job.save()
println "Job ${jobName} criado. Cria a credencial Secret text com ID nox-cms-webhook-token antes do primeiro webhook."
