...
def jobName = "deploy-plutao-webhook"
...
job.setDefinition(new CpsScmFlowDefinition(scm, "ci/jenkins/DeployPlutaoWebhook.Jenkinsfile"))
job.save()
println "Job ${jobName} criado. Cria a credencial Secret text com ID plutao-webhook-token antes do primeiro webhook."
