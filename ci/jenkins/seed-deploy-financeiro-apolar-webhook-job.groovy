...
def jobName = "deploy-financeiro-apolar-webhook"
...
job.setDefinition(new CpsScmFlowDefinition(scm, "ci/jenkins/DeployFinanceiroApolarWebhook.Jenkinsfile"))
job.save()
println "Job ${jobName} criado. Cria a credencial Secret text com ID financeiro-apolar-webhook-token antes do primeiro webhook."
