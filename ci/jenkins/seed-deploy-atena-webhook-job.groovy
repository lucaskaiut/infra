...
def jobName = "deploy-atena-webhook"
...
job.setDefinition(new CpsScmFlowDefinition(scm, "ci/jenkins/DeployAtenaWebhook.Jenkinsfile"))
job.save()
println "Job ${jobName} criado. Cria a credencial Secret text com ID atena-webhook-token antes do primeiro webhook."
