...
def jobName = "deploy-nox-schduler-webhook"
...
job.setDefinition(new CpsScmFlowDefinition(scm, "ci/jenkins/DeployNoxSchdulerWebhook.Jenkinsfile"))
job.save()
println "Job ${jobName} criado. Cria a credencial Secret text com ID nox-schduler-webhook-token antes do primeiro webhook."
