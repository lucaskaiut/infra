...
def jobName = "deploy-monensure-webhook"
...
job.setDefinition(new CpsScmFlowDefinition(scm, "ci/jenkins/DeployMonensureWebhook.Jenkinsfile"))
job.save()
println "Job ${jobName} criado. Cria a credencial Secret text com ID monensure-webhook-token antes do primeiro webhook."
