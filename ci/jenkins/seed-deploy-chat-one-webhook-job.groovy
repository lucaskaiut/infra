...
def jobName = "deploy-chat-one-webhook"
...
job.setDefinition(new CpsScmFlowDefinition(scm, "ci/jenkins/DeployChatOneWebhook.Jenkinsfile"))
job.save()
println "Job ${jobName} criado. Cria a credencial Secret text com ID chat-one-webhook-token antes do primeiro webhook."
