...
def jobName = "deploy-tasksautomation-webhook"
...
job.setDefinition(new CpsScmFlowDefinition(scm, "ci/jenkins/DeployTasksautomationWebhook.Jenkinsfile"))
job.save()
println "Job ${jobName} criado. Cria a credencial Secret text com ID tasksautomation-webhook-token antes do primeiro webhook."
