...
def jobName = "deploy-vulcano-webhook"
...
job.setDefinition(new CpsScmFlowDefinition(scm, "ci/jenkins/DeployVulcanoWebhook.Jenkinsfile"))
job.save()
println "Job ${jobName} criado. Cria a credencial Secret text com ID vulcano-webhook-token antes do primeiro webhook."
