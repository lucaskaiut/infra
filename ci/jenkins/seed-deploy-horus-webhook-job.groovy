...
def jobName = "deploy-horus-webhook"
...
job.setDefinition(new CpsScmFlowDefinition(scm, "ci/jenkins/DeployHorusWebhook.Jenkinsfile"))
job.save()
println "Job ${jobName} criado. Cria a credencial Secret text com ID horus-webhook-token antes do primeiro webhook."
